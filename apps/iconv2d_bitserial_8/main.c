...
extern int8_t f[] __attribute__((aligned(4 * NR_LANES))); // [M x N x L]

extern int8_t o[] __attribute__((aligned(4 * NR_LANES)));
extern int8_t golden_o[] __attribute__((aligned(4 * NR_LANES)));
...
int verify_tensor(int8_t *tensor1, int8_t *tensor2, int64_t R, int64_t C, int64_t D) {
