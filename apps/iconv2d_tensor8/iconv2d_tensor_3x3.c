...
//
//				limited to 1024 x 1024 matrix input (Cmax = Rmax = 1024) for now and 3 x 3 kernel matrices (F = 3)
//																																									
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void iconv2d_tensor_vec_4xC_slice_preload_3x3(int8_t *i, int64_t C, int64_t F) {
  ...
  asm volatile("vle8.v v10, (%0); add %0, %0, %1" : "+&r"(i) : "r"(next_plane)); 
  
  asm volatile("vle8.v v24, (%0); add %0, %0, %1" : "+&r"(i) : "r"(ldi)); //second plabe
  asm volatile("vle8.v v26, (%0); add %0, %0, %1" : "+&r"(i) : "r"(next_plane));
	  
  asm volatile("vle8.v v28, (%0); add %0, %0, %1" : "+&r"(i) : "r"(ldi)); //third plane
  asm volatile("vle8.v v30, (%0); add %0, %0, %1" : "+r"(i)); 
}
...
void iconv2d_tensor_vec_4xC_3x3(int8_t *o, int8_t *i, int8_t *f, int64_t C, int64_t W,
  ...
  int64_t ldo = C;
  int64_t ldi = (C + F - 1);
  int64_t next_plane = (C + F - 4)*(C + F - 1); 
  int64_t ldf = F; //F << 3
  ...
  asm volatile("vmulhu.vx v0, v8 , %0"  ::"r"(t0));  
  asm volatile("vmulhu.vx v2, v10, %0" ::"r"(t0));
  
  asm volatile("vle8.v v14, (%0); add %0, %0, %1" : "+&r"(i) : "r"(ldi));
  asm volatile("vmulhu.vx v4, v12, %0" ::"r"(t0));
  asm volatile("vmulhu.vx v6, v14, %0" ::"r"(t0));
  ...
  asm volatile("vle8.v v18, (%0); add %0, %0, %1" : "+&r"(i) : "r"(next_plane)); 
