...
void NCHW_to_NHWC_tensor32_vec_32xC(int32_t *o, int32_t *i, int64_t R, int64_t C, int64_t W);
void NCHW_to_NHWC_tensor32(int32_t *o, int32_t *i, int64_t R, int64_t C, int64_t W);

void NCHW_to_NHWC_tensor64_vec_32xC(int64_t *o, int64_t *i, int64_t R, int64_t C, int64_t W);
