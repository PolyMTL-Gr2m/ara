...
//                                                                                                             //
//                           1 x W x C x R   *   W x F x F   =   1 x W x C/F x R/F                             //			
...
// W  : channels of the input tensor
...
void imax_pool8(int8_t *o, int8_t *i, int64_t R, int64_t C, int64_t W, int64_t F){
		...
		switch (F){
			 case 2:
					imax_pool_vec_1xC_2x2(o, i, R, C, W, F, F);
				break;

			 case 3:
					imax_pool_vec_1xC_3x3(o, i, R, C, W, F, F);
				break;
		}
...
void iavg_pool8(int8_t *o, int8_t *i, int64_t R, int64_t C, int64_t W, int64_t F){
		...
		switch (F){
			 case 2:
					iavg_pool_vec_1xC_2x2(o, i, R, C, W, F, F);
				break;

			 case 3:
					iavg_pool_vec_1xC_3x3(o, i, R, C, W, F, F);
				break;
		}
...
void imax_pool_vec_1xC_2x2(int8_t *o, int8_t *i, int64_t R, int64_t C, int64_t W, int64_t F, int64_t stride) {
	...
	for (int c = 0 ; c < C ; c += TILE_SIZE) // IF CONVOLUTION NEED TO BE TILED (C > TILE_SIZE)
	{
		...
		for (int r = 0 ; r < R * W ; r += block_size_2x2){
			...
			asm volatile("vsetvli zero, %0, e8, m4, ta, ma" ::"r"(vlen)); // we only load one of two values 
