...
/*void iconv2d_tensor16_vec_4xC_slice_init_3x3(int64_t *o, int64_t C) {
  // Helper variables
  int64_t ldo = C << 3;
...
/*void iconv2d_tensor16_vec_4xC_slice_move_3x3(int64_t C, int64_t F) { //could be implemented direclty in main convolution function conv2d_vec
  // Move C+F-1 elements
  asm volatile("vsetvli zero, %0, e16, m2, ta, ma" ::"r"(C + F - 1));
