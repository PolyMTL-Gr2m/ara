...
//                          input (16b)            kernels (16b)             output (32b)                      //	
//																																					//
//																																					//				
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void iconv2d_tensor16_wide(int32_t *o, int16_t *i, int16_t *f, int64_t H_in, int64_t W_in, int64_t C_in, int64_t F, int64_t C_out) {
  ...
  for(int64_t c = 0; c < C_out; c++) {
	  ...
	  {
	   case 1:
	  		iconv2d_tensor16_vec_1xC_1x1_wide(o_, i_, f_, H_in, W_in, C_in, F);
	  		break;
		case 3:
			iconv2d_tensor16_vec_4xC_3x3_wide(o_, i_, f_, H_in, W_in, C_in, F);
			break;
		case 5:
			iconv2d_tensor16_vec_8xC_5x5_wide(o_, i_, f_, H_in, W_in, C_in, F);
			break;
		case 7:
			iconv2d_tensor16_vec_6xC_7x7_wide(o_, i_, f_, H_in, W_in, C_in, F);
			break;
		}
...
for (int c = 0 ; c < C * R ; c += TILE_SIZE_1x1_WIDE) // IF CONVOLUTION NEED TO BE TILED (C > TILE_SIZE)
{
	...
	asm volatile("lh %1, (%0)" : "+&r"(f_), "=&r"(t[0]));
...
for (int c = 0 ; c < (C - 2) ; c += TILE_SIZE_OUT) // IF CONVOLUTION NEED TO BE TILED (C > TILE_SIZE)
{
	...
	asm volatile("lh %1, (%0)" : "+&r"(f_), "=&r"(t[0]));
	f_ += 3;
	asm volatile("lh %1, (%0)" : "+&r"(f_), "=&r"(t[1]));
	f_ -= 2; 
	...
	asm volatile("vle16.v v26, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(next_plane_(2)));
	...
	for (int r = 2 + block_size_wide_3x3; r < R ; r += block_size_wide_3x3)
	{
		...
		asm volatile("lh %1, (%0)" : "+&r"(f_), "=&r"(t[1]));
		f_ += 3;
		asm volatile("lh %1, (%0)" : "+&r"(f_), "=&r"(t[2]));
		f_ -= 5;
		...
		asm volatile("vle16.v v30, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(next_plane_(4)));
		...
		asm volatile("vsetvli zero, %0, e32, m4, ta, ma" ::"r"(vlen_out));
	...
	else if (last_group == 3)
	{
		asm volatile("vle16.v v24, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		asm volatile("vle16.v v26, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		asm volatile("vle16.v v28, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(next_plane_(3)));
	...
	{
		asm volatile("vle16.v v24, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(next_plane_(1)));
...
for (int c = 0 ; c < (C - 4) ; c += TILE_SIZE_WIDE_OUT) // IF CONVOLUTION NEED TO BE TILED (C > TILE_SIZE_WIDE)
{
	...
	asm volatile("lh %1, (%0)" : "+&r"(f_), "=&r"(t[2]));
	f_ += 5;
	asm volatile("lh %1, (%0)" : "+&r"(f_), "=&r"(t[3]));
	f_ -= 14;
	...
	asm volatile("vle16.v v23, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(next_plane_(4)));
	...
	for (int r = 4 + block_size_wide_5x5; r < R ; r += block_size_wide_5x5)
	{
		...
		asm volatile("lh %1, (%0)" : "+&r"(f_), "=&r"(t[3]));
		f_ += 5;
		asm volatile("lh %1, (%0)" : "+&r"(f_), "=&r"(t[4]));
		f_ -= 19;
		...
		asm volatile("vle16.v v27, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		...
		asm volatile("vle16.v v29, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		...
		asm volatile("vle16.v v30, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		...
		asm volatile("vle16.v v31, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(next_plane_(8)));
	...
	else if (last_group == 7)
	{
		...
		asm volatile("vle16.v v28, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		asm volatile("vle16.v v29, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		asm volatile("vle16.v v30, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(next_plane_(7)));
	...
	else if (last_group == 6)
	{
		...
		asm volatile("vle16.v v27, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		asm volatile("vle16.v v28, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		asm volatile("vle16.v v29, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(next_plane_(6)));
	...
	else if (last_group == 4)
	{
		...
		asm volatile("vle16.v v25, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		asm volatile("vle16.v v26, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		asm volatile("vle16.v v27, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(next_plane_(4)));
	...
	else if (last_group == 3)
	{
		asm volatile("vle16.v v24, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		asm volatile("vle16.v v25, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		asm volatile("vle16.v v26, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(next_plane_(3)));

	}
	else if (last_group == 2)
	{
		asm volatile("vle16.v v24, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		asm volatile("vle16.v v25, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(next_plane_(2)));
...
for (int c = 0 ; c < (C - 6) ; c += TILE_SIZE_WIDE_OUT) // IF CONVOLUTION NEED TO BE TILED (C > TILE_SIZE_WIDE)
{
	...
	asm volatile("lh %1, (%0)" : "+&r"(f_), "=&r"(t[4]));
	f_ += 7;
	asm volatile("lh %1, (%0)" : "+&r"(f_), "=&r"(t[5]));
	f_ -= 34;
	...
	for (int r = 6 + block_size_wide_7x7; r < R ; r += block_size_wide_7x7)
	{
		...
		asm volatile("lh %1, (%0)" : "+&r"(f_), "=&r"(t[5]));
		f_ += 7;
		asm volatile("lh %1, (%0)" : "+&r"(f_), "=&r"(t[6]));
		f_ -= 41;
