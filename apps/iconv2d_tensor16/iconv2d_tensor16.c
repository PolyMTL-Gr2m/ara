...
#define next_plane_(a) ((R - a + 1)*C) << 1
...
void iconv2d_tensor16(int16_t *o, int16_t *i, int16_t *f, int64_t H_in, int64_t W_in, int64_t C_in, int64_t F, int64_t C_out) {
  ...
  for(int64_t c = 0; c < C_out; c++) {
	  ...
	  // Iterate over the output rows
		...
		switch (F){
			 case 1:
					iconv2d_tensor16_vec_1xC_1x1(o_, i_, f_, H_in, W_in, C_in, F);
				break;

			 case 3:
					iconv2d_tensor16_vec_6xC_3x3(o_, i_, f_, H_in, W_in, C_in, F);
				break;
				
			 case 5:
					iconv2d_tensor16_vec_6xC_5x5(o_, i_, f_, H_in, W_in, C_in, F);
				break;
				
			 case 7:
					iconv2d_tensor16_vec_4xC_7x7(o_, i_, f_, H_in, W_in, C_in, F);
				break;
		}
...
for (int c = 0 ; c < C * R ; c += TILE_SIZE_1x1) // IF CONVOLUTION NEED TO BE TILED (C > TILE_SIZE)
{
	...
	asm volatile("vsetvli zero, %0, e16, m8, ta, ma" ::"r"(vlen));
...
int64_t const ldo = (C - 2) << 1;
int64_t const ldi = C << 1;
...
for (int c = 0 ; c < (C - 2) ; c += TILE_SIZE_OUT) // IF CONVOLUTION NEED TO BE TILED (C > TILE_SIZE)
{
	...
	asm volatile("vle16.v v12, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
	asm volatile("vle16.v v14, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(next_plane_(2)));
	...
	for (int r = 2 + block_size_3x3; r < R ; r += block_size_3x3)
	{
		...
		asm volatile("vle16.v v26, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(next_plane_(6)));
		...
		asm volatile("vse16.v v4, (%0); add %0, %0, %1" : "+&r"(o_) : "r"(ldo));
		asm volatile("vse16.v v6, (%0); add %0, %0, %1" : "+&r"(o_) : "r"(ldo));
	...
	else if (last_group == 5)
	{
		...
		asm volatile("vle16.v v20, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		asm volatile("vle16.v v22, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		asm volatile("vle16.v v24, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(next_plane_(5)));
	...
	else if (last_group == 4)
	{
		...
		asm volatile("vle16.v v18, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		asm volatile("vle16.v v20, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		asm volatile("vle16.v v22, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(next_plane_(4)));
	...
	else if (last_group == 3)
	{
		asm volatile("vle16.v v16, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		asm volatile("vle16.v v18, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		asm volatile("vle16.v v20, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(next_plane_(3)));

	}
	else if (last_group == 2)
	{
		asm volatile("vle16.v v16, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		asm volatile("vle16.v v18, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(next_plane_(2)));

	}
	else
	{
		asm volatile("vle16.v v16, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(next_plane_(1)));
	...
	asm volatile("vse16.v v0, (%0); add %0, %0, %1" : "+&r"(o_) : "r"(ldo));
	asm volatile("vse16.v v2, (%0); add %0, %0, %1" : "+&r"(o_) : "r"(ldo));
	asm volatile("vse16.v v4, (%0)" : "+&r"(o_));

	}
	else if (last_group == 2)
	{
	asm volatile("vse16.v v0, (%0); add %0, %0, %1" : "+&r"(o_) : "r"(ldo));
	asm volatile("vse16.v v2, (%0)" : "+&r"(o_));
...
for (int c = 0 ; c < (C - 4) ; c += TILE_SIZE_OUT) // IF CONVOLUTION NEED TO BE TILED (C > TILE_SIZE)
{
	...
	for (int r = 4 + block_size_5x5; r < R ; r += block_size_5x5)
	{
		...
		asm volatile("vle16.v v28, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		...
		asm volatile("vle16.v v30, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(next_plane_(6)));
	...
	else if (last_group == 5)
	{
		...
		asm volatile("vle16.v v24, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		asm volatile("vle16.v v26, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		asm volatile("vle16.v v28, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(next_plane_(5)));
	...
	else if (last_group == 4)
	{
		...
		asm volatile("vle16.v v22, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		asm volatile("vle16.v v24, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		asm volatile("vle16.v v26, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(next_plane_(4)));
	...
	else if (last_group == 3)
	{
		asm volatile("vle16.v v20, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		asm volatile("vle16.v v22, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		asm volatile("vle16.v v24, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(next_plane_(3)));

	}
	else if (last_group == 2)
	{
		asm volatile("vle16.v v20, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
		asm volatile("vle16.v v22, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(next_plane_(2)));

	}
	else
	{
		asm volatile("vle16.v v20, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(next_plane_(1)));
...
for (int c = 0 ; c < (C - 6) ; c += TILE_SIZE_OUT) // IF CONVOLUTION NEED TO BE TILED (C > TILE_SIZE_WIDE)
{
	...
	asm volatile("vle16.v v12, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
	asm volatile("vle16.v v14, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
	asm volatile("vle16.v v16, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
	asm volatile("vle16.v v18, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
	asm volatile("vle16.v v20, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(ldi));
	asm volatile("vle16.v v22, (%0); add %0, %0, %1" : "+&r"(i__) : "r"(next_plane_(6)));
