...
//                          input (16b)            kernels (16b)             output (16b)                      //	
//																																					//
//																																					//				
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void iconv2d_tensor64(int64_t *o, int64_t *i, int64_t *f, int64_t H_in, int64_t W_in, int64_t C_in, int64_t F, int64_t C_out) {
  ...
  for(int64_t c = 0; c < C_out; c++) {
	  ...
	  // Iterate over the output rows
		...
		switch (F){
			 case 1:
					iconv2d_tensor64_vec_4xC_1x1(o_, i_, f_, H_in, W_in, C_in, F);
				break;

			 case 3:
					iconv2d_tensor64_vec_6xC_3x3(o_, i_, f_, H_in, W_in, C_in, F);
				break;
				
			 case 5:
					iconv2d_tensor64_vec_6xC_5x5(o_, i_, f_, H_in, W_in, C_in, F);
				break;
				
			 case 7:
					iconv2d_tensor64_vec_4xC_7x7(o_, i_, f_, H_in, W_in, C_in, F);
				break;
		}
...
for (int c = 0 ; c < C ; c += TILE_SIZE_OUT) // IF CONVOLUTION NEED TO BE TILED (C > TILE_SIZE)
{
	...
	int64_t *f_ = f;
	int64_t *i_ = i + c; 									// input pointer realtive to the tile (constant throughout the tile)
	...
	int64_t * i__ = i_;							// inside tile pointer (change at each load)
	...
	asm volatile("vmul.vx v0,  v8, %0" :: "r"(f_[0]));
	asm volatile("vmul.vx v2,  v10, %0" :: "r"(f_[0]));
	asm volatile("vmul.vx v4,  v12, %0" :: "r"(f_[0]));
	asm volatile("vmul.vx v6,  v14, %0" :: "r"(f_[0]));
	...
	for(int c = 1 ; c < W ; c ++){
		...
		asm volatile("vmacc.vx v0,  %0, v8" ::"r"(f_[0]));
		asm volatile("vmacc.vx v2,  %0, v10" ::"r"(f_[0]));
		asm volatile("vmacc.vx v4,  %0, v12" ::"r"(f_[0]));
		asm volatile("vmacc.vx v6,  %0, v14" ::"r"(f_[0]));
...
for (int c = 0 ; c < (C - 2) ; c += TILE_SIZE_OUT) // IF CONVOLUTION NEED TO BE TILED (C > TILE_SIZE)
{
	...
	asm volatile("vmacc.vx v0,  %0, v14" ::"r"(f_[3]));
	...
	asm volatile("vmacc.vx v0,  %0, v14" ::"r"(f_[4]));
	...
	asm volatile("vmacc.vx v0,  %0, v14" ::"r"(f_[5]));
...
for (int c = 0 ; c < (C - 4) ; c += TILE_SIZE_OUT) // IF CONVOLUTION NEED TO BE TILED (C > TILE_SIZE)
{
	...
	asm volatile("vmul.vx v0,  v20, %0" :: "r"(f_[0]));
	asm volatile("vmul.vx v2,  v22, %0" :: "r"(f_[0]));
	asm volatile("vmul.vx v4,  v24, %0" :: "r"(f_[0]));
	asm volatile("vmul.vx v6,  v26, %0" :: "r"(f_[0]));
	asm volatile("vmul.vx v8,  v28, %0" :: "r"(f_[0]));
	asm volatile("vmul.vx v10,  v30, %0" :: "r"(f_[0]));

	asm volatile("vslidedown.vi v20, v20, 1");

	asm volatile("vmacc.vx v0,  %0, v22" ::"r"(f_[5]));
	asm volatile("vmacc.vx v2,  %0, v24" ::"r"(f_[5]));
	asm volatile("vmacc.vx v4,  %0, v26" ::"r"(f_[5]));
	asm volatile("vmacc.vx v6,  %0, v28" ::"r"(f_[5]));
	asm volatile("vmacc.vx v8,  %0, v30" ::"r"(f_[5]));

	asm volatile("vslidedown.vi v22, v22, 1");

	asm volatile("vmacc.vx v0,  %0, v24" ::"r"(f_[10]));
	asm volatile("vmacc.vx v2,  %0, v26" ::"r"(f_[10]));
	asm volatile("vmacc.vx v4,  %0, v28" ::"r"(f_[10]));
	asm volatile("vmacc.vx v6,  %0, v30" ::"r"(f_[10]));

	asm volatile("vslidedown.vi v24, v24, 1");

	asm volatile("vmacc.vx v0,  %0, v26" ::"r"(f_[15]));
	asm volatile("vmacc.vx v2,  %0, v28" ::"r"(f_[15]));
	asm volatile("vmacc.vx v4,  %0, v30" ::"r"(f_[15]));

	asm volatile("vslidedown.vi v26, v26, 1");

	asm volatile("vmacc.vx v0,  %0, v28" ::"r"(f_[20]));
	asm volatile("vmacc.vx v2,  %0, v30" ::"r"(f_[20]));

	asm volatile("vslidedown.vi v28, v28, 1");
	asm volatile("vslidedown.vi v30, v30, 1");

	asm volatile("vmacc.vx v0,  %0, v20" ::"r"(f_[1]));
	asm volatile("vmacc.vx v2,  %0, v22" ::"r"(f_[1]));
	asm volatile("vmacc.vx v4,  %0, v24" ::"r"(f_[1]));
	asm volatile("vmacc.vx v6,  %0, v26" ::"r"(f_[1]));
	asm volatile("vmacc.vx v8,  %0, v28" ::"r"(f_[1]));
	asm volatile("vmacc.vx v10,  %0, v30" ::"r"(f_[1]));

	asm volatile("vslidedown.vi v20, v20, 1");

	asm volatile("vmacc.vx v0,  %0, v22" ::"r"(f_[6]));
	asm volatile("vmacc.vx v2,  %0, v24" ::"r"(f_[6]));
	asm volatile("vmacc.vx v4,  %0, v26" ::"r"(f_[6]));
	asm volatile("vmacc.vx v6,  %0, v28" ::"r"(f_[6]));
	asm volatile("vmacc.vx v8,  %0, v30" ::"r"(f_[6]));

	asm volatile("vslidedown.vi v22, v22, 1");

	asm volatile("vmacc.vx v0,  %0, v24" ::"r"(f_[11]));
	asm volatile("vmacc.vx v2,  %0, v26" ::"r"(f_[11]));
	asm volatile("vmacc.vx v4,  %0, v28" ::"r"(f_[11]));
	asm volatile("vmacc.vx v6,  %0, v30" ::"r"(f_[11]));

	asm volatile("vslidedown.vi v24, v24, 1");

	asm volatile("vmacc.vx v0,  %0, v26" ::"r"(f_[16]));
	asm volatile("vmacc.vx v2,  %0, v28" ::"r"(f_[16]));
	asm volatile("vmacc.vx v4,  %0, v30" ::"r"(f_[16]));

	asm volatile("vslidedown.vi v26, v26, 1");

	asm volatile("vmacc.vx v0,  %0, v28" ::"r"(f_[21]));
	asm volatile("vmacc.vx v2,  %0, v30" ::"r"(f_[21]));

	asm volatile("vslidedown.vi v28, v28, 1");
	asm volatile("vslidedown.vi v30, v30, 1");

	asm volatile("vmacc.vx v0,  %0, v20" ::"r"(f_[2]));
	asm volatile("vmacc.vx v2,  %0, v22" ::"r"(f_[2]));
	asm volatile("vmacc.vx v4,  %0, v24" ::"r"(f_[2]));
	asm volatile("vmacc.vx v6,  %0, v26" ::"r"(f_[2]));
	asm volatile("vmacc.vx v8,  %0, v28" ::"r"(f_[2]));
	asm volatile("vmacc.vx v10,  %0, v30" ::"r"(f_[2]));

	asm volatile("vslidedown.vi v20, v20, 1");

	asm volatile("vmacc.vx v0,  %0, v22" ::"r"(f_[7]));
	asm volatile("vmacc.vx v2,  %0, v24" ::"r"(f_[7]));
	asm volatile("vmacc.vx v4,  %0, v26" ::"r"(f_[7]));
	asm volatile("vmacc.vx v6,  %0, v28" ::"r"(f_[7]));
	asm volatile("vmacc.vx v8,  %0, v30" ::"r"(f_[7]));

	asm volatile("vslidedown.vi v22, v22, 1");

	asm volatile("vmacc.vx v0,  %0, v24" ::"r"(f_[12]));
	asm volatile("vmacc.vx v2,  %0, v26" ::"r"(f_[12]));
	asm volatile("vmacc.vx v4,  %0, v28" ::"r"(f_[12]));
	asm volatile("vmacc.vx v6,  %0, v30" ::"r"(f_[12]));

	asm volatile("vslidedown.vi v24, v24, 1");

	asm volatile("vmacc.vx v0,  %0, v26" ::"r"(f_[17]));
	asm volatile("vmacc.vx v2,  %0, v28" ::"r"(f_[17]));
	asm volatile("vmacc.vx v4,  %0, v30" ::"r"(f_[17]));

	asm volatile("vslidedown.vi v26, v26, 1");

	asm volatile("vmacc.vx v0,  %0, v28" ::"r"(f_[22]));
	asm volatile("vmacc.vx v2,  %0, v30" ::"r"(f_[22]));

	asm volatile("vslidedown.vi v28, v28, 1");
	asm volatile("vslidedown.vi v30, v30, 1");

	asm volatile("vmacc.vx v0,  %0, v20" ::"r"(f_[3]));
	asm volatile("vmacc.vx v2,  %0, v22" ::"r"(f_[3]));
	asm volatile("vmacc.vx v4,  %0, v24" ::"r"(f_[3]));
	asm volatile("vmacc.vx v6,  %0, v26" ::"r"(f_[3]));
	asm volatile("vmacc.vx v8,  %0, v28" ::"r"(f_[3]));
	asm volatile("vmacc.vx v10,  %0, v30" ::"r"(f_[3]));

	asm volatile("vslidedown.vi v20, v20, 1");

	asm volatile("vmacc.vx v0,  %0, v22" ::"r"(f_[8]));
	asm volatile("vmacc.vx v2,  %0, v24" ::"r"(f_[8]));
	asm volatile("vmacc.vx v4,  %0, v26" ::"r"(f_[8]));
	asm volatile("vmacc.vx v6,  %0, v28" ::"r"(f_[8]));
	asm volatile("vmacc.vx v8,  %0, v30" ::"r"(f_[8]));

	asm volatile("vslidedown.vi v22, v22, 1");

	asm volatile("vmacc.vx v0,  %0, v24" ::"r"(f_[13]));
	asm volatile("vmacc.vx v2,  %0, v26" ::"r"(f_[13]));
	asm volatile("vmacc.vx v4,  %0, v28" ::"r"(f_[13]));
	asm volatile("vmacc.vx v6,  %0, v30" ::"r"(f_[13]));

	asm volatile("vslidedown.vi v24, v24, 1");

	asm volatile("vmacc.vx v0,  %0, v26" ::"r"(f_[18]));
	asm volatile("vmacc.vx v2,  %0, v28" ::"r"(f_[18]));
	asm volatile("vmacc.vx v4,  %0, v30" ::"r"(f_[18]));

	asm volatile("vslidedown.vi v26, v26, 1");

	asm volatile("vmacc.vx v0,  %0, v28" ::"r"(f_[23]));
	asm volatile("vmacc.vx v2,  %0, v30" ::"r"(f_[23]));

	asm volatile("vslidedown.vi v28, v28, 1");
	asm volatile("vslidedown.vi v30, v30, 1");

	asm volatile("vmacc.vx v0,  %0, v20" ::"r"(f_[4]));
	asm volatile("vmacc.vx v2,  %0, v22" ::"r"(f_[4]));
	asm volatile("vmacc.vx v4,  %0, v24" ::"r"(f_[4]));
	asm volatile("vmacc.vx v6,  %0, v26" ::"r"(f_[4]));
	asm volatile("vmacc.vx v8,  %0, v28" ::"r"(f_[4]));
	asm volatile("vmacc.vx v10,  %0, v30" ::"r"(f_[4]));

	asm volatile("vmacc.vx v0,  %0, v22" ::"r"(f_[9]));
	asm volatile("vmacc.vx v2,  %0, v24" ::"r"(f_[9]));
	asm volatile("vmacc.vx v4,  %0, v26" ::"r"(f_[9]));
	asm volatile("vmacc.vx v6,  %0, v28" ::"r"(f_[9]));
	asm volatile("vmacc.vx v8,  %0, v30" ::"r"(f_[9]));

	asm volatile("vmacc.vx v0,  %0, v24" ::"r"(f_[14]));
	asm volatile("vmacc.vx v2,  %0, v26" ::"r"(f_[14]));
	asm volatile("vmacc.vx v4,  %0, v28" ::"r"(f_[14]));
	asm volatile("vmacc.vx v6,  %0, v30" ::"r"(f_[14]));

	asm volatile("vmacc.vx v0,  %0, v26" ::"r"(f_[19]));
	asm volatile("vmacc.vx v2,  %0, v28" ::"r"(f_[19]));
	asm volatile("vmacc.vx v4,  %0, v30" ::"r"(f_[19]));

	asm volatile("vmacc.vx v0,  %0, v28" ::"r"(f_[24]));
	asm volatile("vmacc.vx v2,  %0, v30" ::"r"(f_[24]));
	...
	for(int c = 1 ; c < W ; c ++){
		...
		asm volatile("vmacc.vx v0,  %0, v20" ::"r"(f_[0]));
		asm volatile("vmacc.vx v2,  %0, v22" ::"r"(f_[0]));
		asm volatile("vmacc.vx v4,  %0, v24" ::"r"(f_[0]));
		asm volatile("vmacc.vx v6,  %0, v26" ::"r"(f_[0]));
		asm volatile("vmacc.vx v8,  %0, v28" ::"r"(f_[0]));
		asm volatile("vmacc.vx v10,  %0, v30" ::"r"(f_[0]));
